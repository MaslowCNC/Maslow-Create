 ...
 */
import * as domparser from './svg_util/domparser.js'
import * as Svgparser from './svgparser.js'
import * as ClipperLib from './svg_util/clipper.js'
import * as geometryUtil from './svg_util/geometryutil.js'
import * as placementworker from './svg_util/placementworker.js'
import * as parallel from './svg_util/parallel.js'
            ...
            p.map(function(pair){
                ...
                if(pair.key.inside){
                    ...
                    if(nfp && nfp.length > 0){
                    	...
                    	console.log("Something went wrong with the placement. Check your material size")
