...
class GlobalVariables{
    ...
    constructor(){
        ...
        this.availableTypes = {
            ...
            cutLayout:          {creator: CutLayout, atomType: "Cut Layout", atomCategory: 'Actions'},
            ...
            regularPolygon:     {creator: RegularPolygon, atomType: 'RegularPolygon', atomCategory: 'Actions'},
            ...
            stl:                {creator: Stl, atomType: 'Stl', atomCategory: 'Actions'},
            svg:                {creator: Svg, atomType: 'Svg', atomCategory: 'Actions'},
            ...
            githubmolecule:     {creator: GitHubMolecule, atomType: 'GitHubMolecule', atomCategory: 'Shapes'},
            ...
            gcode:              {creator: Gcode, atomType: 'Gcode', atomCategory: 'Actions'},
            code:               {creator: Code, atomType: 'Code', atomCategory: 'Actions'},
            cutAway:            {creator: CutAway, atomType: 'CutAway', atomCategory: 'Actions'},
            CutList:            {creator: CutList, atomType: 'CutList', atomCategory: 'Actions'}
        }
        /** 
